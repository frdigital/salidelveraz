...
const SHOPIFY_STORE_PERMANENT_DOMAIN = 'xb1mpd-2f.myshopify.com';
const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
const SHOPIFY_STOREFRONT_TOKEN = '9cfd8cd3017f9e073ebba88483fcd7de';
...
export async function storefrontApiRequest(query: string, variables: Record<string, unknown> = {}) {
  ...
  if (response.status === 402) {
    toast.error("Shopify: Pago requerido", {
      description: "Tu tienda Shopify necesita un plan de pago activo para funcionar.",
    });
    return null;
  }
